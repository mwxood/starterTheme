...
function starter_theme_scripts() {
    ...
    wp_enqueue_style('main', get_template_directory_uri() . '/assets/css/main.min.css', array(), $modificated_starter_theme_version_css);
    ...
    function enqueue_custom_scripts_in_footer() {
        ...
        wp_enqueue_script('custom-scripts', get_template_directory_uri() . '/assets/js/custom-scripts.js', null, $modificated_starter_theme_version_js, true);
